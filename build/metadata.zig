...
/// Parses the description field from the manifest.
///
/// This is subject to removal as the field is proposed to be added, but also unknown or custom fields are also proposed to be not allowed.
///
/// See:
///
/// - <https://github.com/ziglang/zig/issues/23816>.
/// - <https://github.com/ziglang/zig/issues/25073>.
